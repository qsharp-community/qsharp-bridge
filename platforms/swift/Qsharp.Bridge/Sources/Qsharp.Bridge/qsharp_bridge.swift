...
public protocol ExecutionOptionsProtocol {
    
}

public class ExecutionOptions: ExecutionOptionsProtocol {
    ...
    public static func fromNoise(noise: PauliDistribution)  -> ExecutionOptions {
        return ExecutionOptions(unsafeFromRawPointer: try! rustCall() {
...
public struct FfiConverterTypeQasmGenerationOptions: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> QasmGenerationOptions {
        return try QasmGenerationOptions(
...
public enum QsError {
    ...
    fileprivate static func uniffiErrorHandler(_ error: RustBuffer) throws -> Error {
        return try FfiConverterTypeQsError.lift(error)
    }
}
...
public func circuit(source: String) throws -> Circuit {
    return try  FfiConverterTypeCircuit.lift(
        try rustCallWithError(FfiConverterTypeQsError.lift) {
...
public func runQs(source: String) throws -> ExecutionState {
    return try  FfiConverterTypeExecutionState.lift(
        try rustCallWithError(FfiConverterTypeQsError.lift) {
...
public func runQsWithOptions(source: String, options: ExecutionOptions) throws -> [ExecutionState] {
    return try  FfiConverterSequenceTypeExecutionState.lift(
        try rustCallWithError(FfiConverterTypeQsError.lift) {
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_qsharp_bridge_checksum_func_circuit() != 37793) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_func_estimate() != 32545) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_func_estimate_expression() != 32630) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_func_qasm2() != 56834) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_func_qasm2_expression() != 31194) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_func_qir() != 30841) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_func_run_qs() != 45212) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_func_run_qs_with_options() != 54102) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_constructor_executionoptions_from_noise() != 38914) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_constructor_executionoptions_from_shots() != 49847) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_qsharp_bridge_checksum_constructor_executionoptions_new() != 45091) {
        return InitializationResult.apiChecksumMismatch
    }
